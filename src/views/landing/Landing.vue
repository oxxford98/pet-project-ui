...
// Variable reactiva que indica qué mostrar
...
<template>
    ...
    <section v-else-if="seccionActual === 'quienes'">
    ...
    <section v-else-if="seccionActual === 'planes'">
        <div>
        ...
        <div class="flex flex-col md:flex-row items-start gap-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    <!-- Plan corto: 1 mes -->
                        <div class="border rounded-lg p-4 shadow-sm bg-gray-200">
                            ...
                            <router-link to="/auth/register" class="inline-block w-full text-center bg-primary-500 text-white py-2 rounded">Matricular</router-link>
                        </div>
    ...
    <section v-else-if="seccionActual === 'contacto'">
                ...
                <div class="lg:col-span-2 p-6">
                    ...
                    <div class="mt-6">
                        ...
                        <div class="flex gap-3">
                            <a href="https://wa.me/573125550199" target="_blank" class="inline-block px-4 py-2 bg-green-500 text-white rounded font-semibold">Enviar WhatsApp</a>
                            <a href="mailto:info@caneduca.example?subject=Consulta%20desde%20landing" class="inline-block px-4 py-2 border rounded">Enviar correo</a>
                        </div>
                    </div>
                </div>

                <!-- Right: Mini contact card / demo form (static) -->
                <aside class="p-4 bg-gradient-to-br from-primary-500 to-green-400 text-white rounded-lg">
