<template>
    ...
    <Message v-else-if="!pets.length" severity="info" class="w-full"> No tienes mascotas registradas aún. </Message>

    <div v-else class="grid grid-cols-12 gap-4">
        <div v-for="pet in pets" :key="pet.id" class="col-span-12 md:col-span-6 xl:col-span-4">
            <Card>
                <template #header>
                    <div
    ...
    <PlanModal v-model:visible="showPlans" :pet-id="selectedPetId" @enrolled="onEnrolled" @error="onError" />
</template>
