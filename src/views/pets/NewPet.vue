    ...
    <Card>
        ...
        <template #content>
            <div class="grid grid-cols-2 gap-4">
                <FloatLabel class="my-4">
                    <InputText id="name" v-model="form.name" class="w-full" :invalid="validate && !form.name" />
                    <label for="name">Nombre *</label>
                </FloatLabel>

                <FloatLabel class="my-4">
                    <InputText id="breed" v-model="form.breed" class="w-full" :invalid="validate && !form.breed" />
            ...
            <Message v-if="validate && !isFormValidBasic" severity="error" size="small" class="mt-2">
        ...
        <template #footer>
            <div class="flex justify-end gap-2 p-4">
                <Button label="Limpiar" icon="pi pi-replay" severity="secondary" outlined @click="resetForm" />
